...
#define ALLOPS_FINITEPARAMS_WPAREN_NOFORK (READ) (WRITE) (CLOSE) (SEEK) (TRUNC) (DUP) (DUP2) (READV) (WRITEV) (PIPE) OPS_FINITEPARAMS_64 (PREAD) (PWRITE) (FSYNC) (FDSYNC) (SOCKET) (ACCEPT) (UNLINK)
